...
//            System.out.println("步骤 3: 并行计算可见性...");
            // 记录开始时间
            visibilityStartTimeMillis = System.currentTimeMillis();
            ...
            visibilityEndTimeMillis = System.currentTimeMillis();
...
//            System.out.println("星历生成完成. 耗时: " + (ephemerisEndTimeMillis - ephemerisStartTimeMillis) + " 毫秒");
//            System.out.println("可见性计算完成. 耗时: " + (visibilityEndTimeMillis - visibilityStartTimeMillis) + " 毫秒");
